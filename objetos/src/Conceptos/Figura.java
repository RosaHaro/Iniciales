...
public class Figura {
    ...
    public static void MenuIfSwitch() {
        int opcion;
        char respuesta;
        ...
        while (continuar) { //Bucle whille (mientras) -> Se ejecuta mientras la CONDICION ES CIERTA
            ...
            switch (opcion) {
                case 1:
                    ...
                    System.out.println("El área del cuadrado es = " + Figura.area +"m2");
                    break; //sale del switch--> no sigue comparando CASOS
                    case 2:
                    Figura.area = Figura.AreaRectangulo();
                    System.out.println("El área del rectángulo es = " + Figura.area +"m2");
                    break;
                case 3:
                    Figura.area = Figura.AreaTriangulo();
                    System.out.println("El área del triángulo es = " + Figura.area +"m2");
                    break;
                case 4:
                    Figura.area = Figura.AreaCirculo();
                    System.out.println("El área del circulo es = " + Figura.area +"m2");
                    break;
                case 5:
                   //tarea prisma System.out.println("El área del circulo es = " + Figura.area +"m2");
                default:
